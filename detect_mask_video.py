...
while True:
    ...
    if (accuracy > 97):
        if True:
            ...
            client.publish(credentiels.mqttTopic, label)
    #			subscribe(client)
    ...
    # if the ESC key was pressed, break from theF loop
    if key == 27:
        break
...
client.disconnect()
client.loop_stop()
print("[INFO] Disonnected from MQTT Broker!")
vs.stop()
